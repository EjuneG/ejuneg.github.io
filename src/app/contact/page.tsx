...
export default function Contact() {
  return (
    <div className="max-w-4xl mx-auto p-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">联系方式</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <form className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-gray-800 mb-1">姓名</label>
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-gray-800 mb-1">邮箱</label>
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-gray-800 mb-1">消息</label>
